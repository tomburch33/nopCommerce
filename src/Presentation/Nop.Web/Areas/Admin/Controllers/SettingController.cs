...
namespace Nop.Web.Areas.Admin.Controllers
{
    public partial class SettingController : BaseAdminController
    {
        ...
        public virtual IActionResult Catalog(CatalogSettingsModel model)
        {
            ...
            _settingService.SaveSettingOverridablePerStore(catalogSettings, x => x.AttributeValueOutOfStockDisplayType, model.AttributeValueOutOfStockDisplayType_OverrideForStore, storeScope, false);
