...
namespace Nop.Web.Areas.Admin.Validators.Blogs
{
    ...
    {
        public BlogPostValidator(ILocalizationService localizationService, IMigrationManager migrationManager)
        {
            RuleFor(x => x.Title)
                .NotEmpty()
            ...
            SetDatabaseValidationRules<BlogPost>(migrationManager);
        }
    }
}