...
namespace Nop.Web.Areas.Admin.Validators.News
{
    ...
    {
        public NewsItemValidator(ILocalizationService localizationService, IMigrationManager migrationManager)
        {
            ...
            SetDatabaseValidationRules<NewsItem>(migrationManager);
        }
    }
}