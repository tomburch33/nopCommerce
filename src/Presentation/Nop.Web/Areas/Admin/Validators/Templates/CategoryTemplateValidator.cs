...
namespace Nop.Web.Areas.Admin.Validators.Templates
{
    ...
    {
        public CategoryTemplateValidator(ILocalizationService localizationService, IMigrationManager migrationManager)
        {
            ...
            SetDatabaseValidationRules<CategoryTemplate>(migrationManager);
        }
    }
}