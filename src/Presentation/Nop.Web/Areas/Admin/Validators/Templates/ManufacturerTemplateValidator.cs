...
namespace Nop.Web.Areas.Admin.Validators.Templates
{
    ...
    {
        public ManufacturerTemplateValidator(ILocalizationService localizationService, IMigrationManager migrationManager)
        {
            ...
            SetDatabaseValidationRules<ManufacturerTemplate>(migrationManager);
        }
    }
}