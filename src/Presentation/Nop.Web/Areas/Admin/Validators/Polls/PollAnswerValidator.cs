...
namespace Nop.Web.Areas.Admin.Validators.Polls
{
    ...
    {
        public PollAnswerValidator(ILocalizationService localizationService, IMigrationManager migrationManager)
        {
            ...
            RuleSet(NopValidatorDefaults.ValidationRuleSet, () =>
            {
                ...
                SetDatabaseValidationRules<PollAnswer>(migrationManager);
            });
        }
    }
}