...
namespace Nop.Web.Areas.Admin.Validators.Messages
{
    ...
    {
        public CampaignValidator(ILocalizationService localizationService, IMigrationManager migrationManager)
        {
            ...
            SetDatabaseValidationRules<Campaign>(migrationManager);
        }
    }
}