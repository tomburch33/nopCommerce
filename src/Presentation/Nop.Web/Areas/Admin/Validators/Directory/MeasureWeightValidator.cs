...
namespace Nop.Web.Areas.Admin.Validators.Directory
{
    ...
    {
        public MeasureWeightValidator(ILocalizationService localizationService, IMigrationManager migrationManager)
        {
            ...
            SetDatabaseValidationRules<MeasureWeight>(migrationManager);
        }
    }
}