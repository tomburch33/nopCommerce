...
namespace Nop.Web.Areas.Admin.Validators.Catalog
{
    ...
    {
        public ManufacturerValidator(ILocalizationService localizationService, IMigrationManager migrationManager)
        {
            ...
            SetDatabaseValidationRules<Manufacturer>(migrationManager);
        }
    }
}