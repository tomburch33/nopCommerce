...
namespace Nop.Web.Areas.Admin.Validators.Catalog
{
    ...
    {
        public CategoryValidator(ILocalizationService localizationService, IMigrationManager migrationManager)
        {
            ...
            SetDatabaseValidationRules<Category>(migrationManager);
        }
    }
}