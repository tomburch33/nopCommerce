...
namespace Nop.Web.Areas.Admin.Validators.Catalog
{
    ...
    {
        public ProductValidator(ILocalizationService localizationService, IMigrationManager migrationManager)
        {
            RuleFor(x => x.Name)
                .NotEmpty()
            ...
            SetDatabaseValidationRules<Product>(migrationManager);
        }
    }
}