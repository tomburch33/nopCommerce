...
namespace Nop.Web.Areas.Admin.Validators.Catalog
{
    ...
    {
        public ProductAttributeValueModelValidator(ILocalizationService localizationService, IMigrationManager migrationManager)
        {
            RuleFor(x => x.Name)
                .NotEmpty()
            ...
            SetDatabaseValidationRules<ProductAttributeValue>(migrationManager);
        }
    }
}