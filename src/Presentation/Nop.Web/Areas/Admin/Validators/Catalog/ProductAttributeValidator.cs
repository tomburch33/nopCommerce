...
namespace Nop.Web.Areas.Admin.Validators.Catalog
{
    ...
    {
        public ProductAttributeValidator(ILocalizationService localizationService, IMigrationManager migrationManager)
        {
            ...
            SetDatabaseValidationRules<ProductAttribute>(migrationManager);
        }
    }
}