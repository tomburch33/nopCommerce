    ...
    public class NivoSliderPlugin : BasePlugin, IWidgetPlugin
    {
        ...
        public override async Task InstallAsync()
        {
            ...
            var settings = new NivoSliderSettings
            {
                ...
                Picture3Id = (await _pictureService.InsertPictureAsync(await _fileProvider.ReadAllBytesAsync(_fileProvider.Combine(sampleImagesPath, "banner3.jpg")), MimeTypes.ImagePJpeg, "banner_3")).Id,
                Text3 = "",
                Link3 = _webHelper.GetStoreLocation(false),
                Picture4Id = (await _pictureService.InsertPictureAsync(await _fileProvider.ReadAllBytesAsync(_fileProvider.Combine(sampleImagesPath, "banner4.jpg")), MimeTypes.ImagePJpeg, "banner_4")).Id,
                Text4 = "",
                Link4 = _webHelper.GetStoreLocation(false),
                Picture5Id = (await _pictureService.InsertPictureAsync(await _fileProvider.ReadAllBytesAsync(_fileProvider.Combine(sampleImagesPath, "banner5.jpg")), MimeTypes.ImagePJpeg, "banner_5")).Id,
                Text5 = "",
                Link5 = _webHelper.GetStoreLocation(false),
                Picture6Id = (await _pictureService.InsertPictureAsync(await _fileProvider.ReadAllBytesAsync(_fileProvider.Combine(sampleImagesPath, "banner6.jpg")), MimeTypes.ImagePJpeg, "banner_6")).Id,
                Text6 = "",
                Link6 = _webHelper.GetStoreLocation(false),
                Picture7Id = (await _pictureService.InsertPictureAsync(await _fileProvider.ReadAllBytesAsync(_fileProvider.Combine(sampleImagesPath, "banner7.jpg")), MimeTypes.ImagePJpeg, "banner_7")).Id,
                Text7 = "",
                Link7 = _webHelper.GetStoreLocation(false),
                Picture8Id = (await _pictureService.InsertPictureAsync(await _fileProvider.ReadAllBytesAsync(_fileProvider.Combine(sampleImagesPath, "banner8.jpg")), MimeTypes.ImagePJpeg, "banner_8")).Id,
                Text8 = "",
                Link8 = _webHelper.GetStoreLocation(false),
                Picture9Id = (await _pictureService.InsertPictureAsync(await _fileProvider.ReadAllBytesAsync(_fileProvider.Combine(sampleImagesPath, "banner9jpg")), MimeTypes.ImagePJpeg, "banner_9")).Id,
                Text9 = "",
                Link9 = _webHelper.GetStoreLocation(false),
                Picture10Id = (await _pictureService.InsertPictureAsync(await _fileProvider.ReadAllBytesAsync(_fileProvider.Combine(sampleImagesPath, "banner10.jpg")), MimeTypes.ImagePJpeg, "banner_10")).Id,
                Text10 = "",
                Link10 = _webHelper.GetStoreLocation(false)
