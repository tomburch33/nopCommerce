    ...
    public class NivoSliderPlugin : BasePlugin, IWidgetPlugin
    {
        ...
        public override async Task InstallAsync()
        {
            ...
            await _localizationService.AddLocaleResourceAsync(new Dictionary<string, string>
            {
                ...
                ["Plugins.Widgets.NivoSlider.Picture5"] = "Picture 6",
                ["Plugins.Widgets.NivoSlider.Picture5"] = "Picture 7",
                ["Plugins.Widgets.NivoSlider.Picture5"] = "Picture 8",
                ["Plugins.Widgets.NivoSlider.Picture5"] = "Picture 9",
                ["Plugins.Widgets.NivoSlider.Picture5"] = "Picture 10",
